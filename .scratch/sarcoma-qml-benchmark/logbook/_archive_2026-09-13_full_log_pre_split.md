> Archived 2026-09-23. This file is the full logbook exactly as it stood before it got
> split into separate per-day files (see `logbook/2026-09-13_data_acquisition.md`,
> `logbook/2026-09-22_restructure_and_uterine_confound.md`, and
> `logbook/2026-09-23_marker_check_and_step6_merge.md`). Kept here so nothing from the
> original formal-voice entries or the 2026-09-23 style-pass rewrite gets lost. Not
> meant to be read day to day going forward, use the split files instead.
